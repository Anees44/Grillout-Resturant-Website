...
const eventsData = [
  {
    ...
    location: 'Grillout Main Hall, RoofTop',
    description:
      'Celebrate your special day in style with us at Grillout! Enjoy a fun-filled night with customized birthday BBQ platters, refreshing drinks, and live entertainment.',
    image: '/eventassets/event2.jpg',
  },
  {
    id: 2,
    title: 'Bridal Shower Celebration',
    ...
    location: 'Grillout Main Hall, RoofTop',
    description:
      'Join us for an elegant and memorable bridal shower at the beautiful Grillout Garden. Enjoy deliciously crafted dishes, refreshing drinks, and a charming atmosphere.',
    image: '/eventassets/bridalevent.jpg',
  },
  {
    id: 3,
    title: 'Wedding Anniversary Celebration',
    ...
    location: 'Grillout Main Hall, RoofTop',
    description:
      'Celebrate love and togetherness with an unforgettable evening at Grillout Lounge. Enjoy a romantic setting, gourmet grilled dishes, and special anniversary cocktails.',
    image: '/eventassets/weddingevent.jpeg',
  },
];
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
          <div className="relative">
            <Image
              ...
              height={600}
              className="max-w-full max-h-screen rounded-lg"
              unoptimized // Only needed for dynamic image paths
            />
            <button
              className="absolute top-4 right-4 text-white text-2xl"
              onClick={closeModal}
