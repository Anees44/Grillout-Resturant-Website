...
function Wings() {
  ...
  const foodItems = [
    {
      name: "Fried Wings",
      sizes: { "5 Pcs": "419", "10 Pcs": "769" },
      image: "/wingsassets/friedwings.jpg",
    },
    {
      name: "Honey Wings",
      sizes: { "5 Pcs": "469", "10 Pcs": "829" },
      image: "/wingsassets/honeywings.jpg",
    },
    {
      name: "Grilled Wings",
      sizes: { "5 Pcs": "369", "10 Pcs": "619" },
      image: "/wingsassets/grilledwings.jpg",
    },
    {
      name: "Peri Peri Wings",
      sizes: { "5 Pcs": "449", "10 Pcs": "849" },
      image: "/wingsassets/periwings.jpg",
    },
    {
      name: "BBQ Wings",
      sizes: { "5 Pcs": "449", "10 Pcs": "799" },
      image: "/wingsassets/bbqwings.jpg",
    },
  ];
      ...
      <div className="max-h-[450px]">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-4 w-full text-xs font-extrabold text-white max-w-[800px] mx-auto">
          {foodItems.map((item, index) => (
            <article className="flex flex-col items-center" key={index}>
              <div
                className="relative aspect-square w-[80px] h-[80px] md:w-[150px] md:h-[150px] lg:w-[180px] lg:h-[180px] cursor-pointer"
                onClick={() => handleImageClick(item.image)}
              >
                <Image
                  src={item.image}
